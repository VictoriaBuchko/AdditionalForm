namespace AdditionalForm
{
    public partial class MainForm : Form
    {
        ...
        private void ButtonAddTask_Click(object sender, EventArgs e)
        {
            ...
            {
                Owner = this // позначення основної форми
            };
            taskForm.ShowDialog();
        }
        ...
        public void AddTask(Task newTask)// метод для додавання завдання з додаткової форми до списку в основній
        {
            tasks.Add(newTask);
            UpdateTaskList();
        }
        ...
        private void ButtonTaskInfo_Click(object sender, EventArgs e)
        {
            if (listBoxTask.SelectedItem != null)
            {
                ...
                if (selectedTask != null)
                {
                    string attachments = selectedTask.Attachments.Count > 0 ? string.Join("\n", selectedTask.Attachments) : "no files";
            ...
            {
                MessageBox.Show("Select a task to view information.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
